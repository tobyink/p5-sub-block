# Sub-Block Security Policy

The [latest stable release on CPAN](https://metacpan.org/release/Sub-Block)
...
[the Changes file on CPAN](https://metacpan.org/changes/distribution/Sub-Block)
